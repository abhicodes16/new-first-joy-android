package dhdeveloper.com.firstjoy.helper;
...
import dhdeveloper.com.firstjoy.activity.MainActivity;
import dhdeveloper.com.firstjoy.activity.OrderListActivity;
import dhdeveloper.com.firstjoy.activity.ProductDetailActivity;
import dhdeveloper.com.firstjoy.activity.SubCategoryActivity;
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        if (remoteMessage.getData().size() > 0) {
            try {
                ...
                Log.e("==n_response", json.toString());
